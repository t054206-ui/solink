...
manufacturers ─1:N─ solar_products ─1:N─ solar_product_sources (one row per document) · solar_products ─1:N─ solar_product_prices ─N:1─ provider_companies (supplier prices, apart from datasheet data; 0011)
