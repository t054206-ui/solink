...
until decided. Nothing has been assumed silently. Decisions 19 to 22 were added in Session 7 (2026-09-21/22).
...
| 22 | **Apply migration 0007 (manufacturer portal)?** Written 2026-09-22, not applied: manufacturer profile columns (logo, description, contact, categories), a storage policy so manufacturers can upload datasheets under their own products, a `manufacturer_requests` table with RLS, and `product_events` for views/comparisons. Until applied, those portal sections show honest empty states. Additive and nullable; review the policies, then say yes. | — | `supabase/migrations/0007_solink_manufacturer_portal.sql` |
