...
| Products | **46 real panels** (11 from Session 8 + 28 from this session + 7 LONGi LR8-66HGD on 2026-09-23 from the owner's CSV, C-018), all Unverified, zero validation flags, one version each, `series` on every row, two `solar_product_sources` rows (datasheet + product page) each. New: LONGi Hi-MO X6 Scientist LR7-72HTH 620/625/630 (single glass, 15 y/25 y, 89.4 %); JinkoSolar Tiger Neo 66HL4M-(V) 610–635 mono-facial (6); JA Solar DeepBlue 4.0 Pro JAM72D42 LB 625–650 bifacial (6); Trina Vertex N TSM-NEG21C.20 700–725 bifacial (6); Canadian Solar TOPBiHiKu6 CS6.2-66TB-H 590–620 bifacial (7). Official renders on every row: JA Solar and Canadian Solar on import day, LONGi, JinkoSolar and Trina added 2026-09-23 with a browser (cell counts checked; C-011 to C-017). No prices: none found. |
