...
export function Footer() {
  return (
    <footer className="border-t border-border bg-elevated">
      ...
      <div className="border-t border-border py-4 text-center text-[12px] text-fg-muted">© {new Date().getFullYear()} Solink · Analyze → Calculate → Compare → Design → Purchase → Install → Monitor → Maintain → Report → Optimize</div>
    </footer>
  );
}
