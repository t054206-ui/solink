  ...
  return (
    <div className={cn("mb-4 flex flex-col gap-3 border-b border-border pb-3 sm:flex-row sm:items-end sm:justify-between", className)}>
      <div className="min-w-0">
        {eyebrow && <div className="mb-1.5 text-[10.5px] font-semibold uppercase tracking-[0.1em] text-fg-mustard">{eyebrow}</div>}
        <h1 className="text-[19px] font-semibold tracking-[-0.012em] text-fg-heading sm:text-[22px]">{title}</h1>
