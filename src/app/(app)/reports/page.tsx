...
export default async function ReportsPage() {
  ...
  return (
    <div>
      <PageHeader eyebrow="Operate" title="Monthly reports" description="One report per month: energy produced, what it may have saved, maintenance activity and environmental impact. Any figure that needs an input Solink does not have is shown as unavailable." />
      ...
      {system ? (
        <ReportsIndex mode={mode} serverReports={reports} systems={systems} production={production} cases={cases} incidents={incidents} assumptions={assumptions} months={months} />
      ) : (
