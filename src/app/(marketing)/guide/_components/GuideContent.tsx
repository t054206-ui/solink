/** The User Guide body, shared by the public /guide page and the in-app /help page (which keeps the sidebar). */
...
export function GuideContent({ inApp = false }: { inApp?: boolean }) {
  return (
    <>
      {/* ───────────── Hero ───────────── */}
      <section className={inApp ? "sun-screen relative overflow-hidden rounded-[var(--radius-lg)] border border-border" : "sun-screen relative overflow-hidden border-b border-border"}>
        <div className={inApp ? "relative px-5 py-10 sm:px-8 sm:py-12" : "relative mx-auto max-w-6xl px-4 pb-14 pt-16 sm:px-6 sm:pb-20 sm:pt-24"}>
      ...
      {/* ───────────── Body: TOC + content ───────────── */}
      <div className={inApp ? "py-8 sm:py-10" : "mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14"}>
